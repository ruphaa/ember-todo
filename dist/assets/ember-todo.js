  ...
  var _default = Ember.Component.extend({
    ...
    actions: {
      ...
      deleteTodo: function (todo) {
        this.store.findRecord("todo", todo.id).then(function (todo) {
